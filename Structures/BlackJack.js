  ...
  try {
    ...
    if (normalembed == false) {
      normalembed = new Discord.MessageEmbed()
        ...
        .setColor("RANDOM")
        .addField(`Your hand`, `Cards: [\`${yourcontent.join("\`](https://discord.link/owlvernyte) [\`")}\`](https://discord.link/owlvernyte)\nTotal: \`${addco}${value}\``, true)
        .addField(`${client.user.username}'s hand`, `Cards: [\`${dealerdeck[0].emoji} ${dealerdeck[0].rank}\`](https://discord.link/owlvernyte) \` ? \`\nTotal: \` ? \``, true)
      ...
      // let staybutton = new MessageButton()
      //     .setStyle('blurple')
      //     .setLabel('Stay')
      //     .setEmoji('✋')
      //     .setID('stay')
      ...
      // var normalbuttons = new MessageActionRow()
      //     .addComponents(hitbutton,staybutton,cancelbutton)
    } else {
      normalembed.fields[0].value = normalembed.fields[0].value.replace(`{yourcontent}`, `[\`${yourcontent.join("\`](https://discord.link/owlvernyte) [\`")}\`](https://discord.link/owlvernyte)`).replace("{yvalue}", `${addco}${value}`)
      normalembed.fields[1].value = normalembed.fields[1].value.replace(`{dcontent}`, `[\`${dealerdeck[0].emoji} ${dealerdeck[0].rank}\`](https://discord.link/owlvernyte)   \` ? \``).replace("{dvalue}", `?`)
      copiedEmbed.content = `[\`${yourcontent.join("\`](https://discord.link/owlvernyte) [\`")}\`](https://discord.link/owlvernyte)`
    ...
    let winembed = new Discord.MessageEmbed()
      ...
      .setColor("GREEN")
      .addField(`Your hand`, `Cards: [\`${yourcontent.join("`](https://discord.link/owlvernyte)   [`")}\`](https://discord.link/owlvernyte)\nTotal: \`${addco}${value}\``, true)
      .addField(`${client.user.username}'s hand`, `Cards: [\`${dealercontent.join("`](https://discord.link/owlvernyte)   [`")}\`](https://discord.link/owlvernyte)\nTotal: \`${dvalue}\``, true)
      .setTitle(`You won!`)
    ...
    let normalcontent = `Type \`h\` to draw a card or type \`s\` to stay.`
    let doubledown = `Type \`h\` to draw a card, type \`s\` to stay or type \`d\` to double down.`
    let split = `Type \`h\` to draw a card, type \`s\` to stay or \`split\` to split.`
    let content = normalcontent

    let answers1 = ["h", "hit", "hi", "e", "en", "end", "s", "stay", "st", "sta", "stay"] // normalcontent
    let answers2 = ["h", "hit", "hi", "e", "en", "end", "s", "stay", "st", "sta", "stay", "d", "dd", "double-down", "double down"] // doubledown
    let answers3 = ["h", "hit", "hi", "e", "en", "end", "s", "stay", "st", "sta", "stay", "sp", "split", "spl", "spli"] // split

    //answers1.includes(button.id)
    ...
    //ori.createButtonCollector(filter, {time: 30000})

    await message.channel.awaitMessages(filter, { max: 1, time: 60000 }).then(
      async allresponses => {
        allresponses.forEach(async (res, value, all) => {
          const findMess = await message.channel.messages.fetch(res)
          const mess = (findMess.first()) ? findMess.first() : NULL
        ...
        if (!allresponses.size) {
          ...
          if (["h", "hit", "hi"].includes(theanswer)) {
            ...
            if (options.normalEmbed == true) {
              normalembed.fields[0].value = `Cards: [\`${yourcontent.join("`](https://discord.link/owlvernyte)   [`")}\`](https://discord.link/owlvernyte)\nTotal: \`${addco}${value}\``
            } else {
              normalembed.fields[0].value = normalembed.fields[0].value.replace(copiedEmbed.content, `[\`${yourcontent.join("`](https://discord.link/owlvernyte)   [`")}\`](https://discord.link/owlvernyte)`).replace(`{yvalue}`, `${addco}${value}`)
              copiedEmbed.content = `[\`${yourcontent.join("`](https://discord.link/owlvernyte)   [`")}\`](https://discord.link/owlvernyte)`
              copiedEmbed.value = `${addco}${value}`
            }
            ori.edit(normalcontent, { embed: normalembed })
            normalembed.fields[0].value = normalembed.fields[0].value.replace(copiedEmbed.value, `{yvalue}`)
            startAt++
            if (endtrue == false) {
              if (value >= 21) {
            ...
            responsenow = "cancel"
          } else if (["s", "st", "sta", "stay"].includes(theanswer)) {
            responsenow = "s"
    ...
    while (responsenow == "h") {
      ...
      await message.channel.awaitMessages(filter1, { max: 1, time: 60000 }).then(async allresponses => {
        allresponses.forEach(async (res, value, all) => {
          const findMess = await message.channel.messages.fetch(res)
          const mess = (findMess.first()) ? findMess.first() : NULL
          if (mess) await mess.delete()
    ...
    while (responsenow == "s") {
      ...
      if (value > 21 || (dvalue <= 21 && value < dvalue)) {
        ...
        loseembed.fields[0].value = `Cards: [\`${yourcontent.join("`](https://discord.link/owlvernyte)   [`")}\`](https://discord.link/owlvernyte)\nTotal: \`${addco}${value}\``
        loseembed.fields[1].value = `Cards: [\`${dealercontent.join("`](https://discord.link/owlvernyte)   [`")}\`](https://discord.link/owlvernyte)\nTotal: \`${dvalue}\``
        if (options.resultEmbed == true) {
          ori.edit({ content: `\u200b`, embed: loseembed })
        }
        RESULTS = "Lose"
        if (doubledtrue == true) {
          RESULTS = "Double Lose"
        ...
        winembed.fields[0].value = `Cards: [\`${yourcontent.join("`](https://discord.link/owlvernyte)   [`")}\`](https://discord.link/owlvernyte)\nTotal: \`${addco}${value}\``
        winembed.fields[1].value = `Cards: [\`${dealercontent.join("`](https://discord.link/owlvernyte)   [`")}\`](https://discord.link/owlvernyte)\nTotal: \`${dvalue}\``
        if (options.resultEmbed == true) {
          ori.edit({ content: `\u200b`, embed: winembed })
        }
        RESULTS = "Win"
        if (doubledtrue == true) {
          RESULTS = "Double Win"
        ...
        method = "Tie"
        tieembed.fields[0].value = `Cards: [\`${yourcontent.join("`](https://discord.link/owlvernyte)   [`")}\`](https://discord.link/owlvernyte)\nTotal: \`${addco}${value}\``
        tieembed.fields[1].value = `Cards: [\`${dealercontent.join("`](https://discord.link/owlvernyte)   [`")}\`](https://discord.link/owlvernyte)\nTotal: \`${dvalue}\``
        if (options.resultEmbed == true) {
          ori.edit({ content: `\u200b`, embed: tieembed })
        }
        RESULTS = "Tie"
      } else {
        let errEmbed = new Discord.MessageEmbed()
          ...
          .setColor("#FF0000")
        if (options.resultEmbed == true) {
          ori.edit({ content: `\u200b`, embed: errEmbed })
        }
        RESULTS = "ERROR"
      }
    }
    ...
    while (responsenow == "cancel") {
      games.delete(message.author.id)
      if (options.resultEmbed == true) {
        ori.edit({ content: `\u200b`, embed: cancelembed })
      }
      responsenow = "INVALID"
      RESULTS = "Cancel"
    }
    ...
    while (responsenow == "timeout") {
      games.delete(message.author.id)
      if (options.resultEmbed == true) {
        ori.edit({ content: `\u200b`, embed: noResEmbed })
      }
      RESULTS = "Timeout"
      responsenow = "INVALID"
    }
    ...
    let FINALRESULTS = {
      ...
      yvalue: `${addco}${value}`,
      dvalue: dvalue,
      ycontent: `[\`${yourcontent.join("`](https://discord.link/owlvernyte)   [`")}\`](https://discord.link/owlvernyte)`,
      dcontent: `[\`${dealercontent.join("`](https://discord.link/owlvernyte)   [`")}\`](https://discord.link/owlvernyte)`,
      yrank: yourrank,
      yemoji: youremoji,
      drank: dealerrank,
      demoji: dealeremoji
